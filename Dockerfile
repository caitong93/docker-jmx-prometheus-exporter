...
RUN curl --insecure -L https://github.com/hairyhenderson/gomplate/releases/download/v2.2.0/gomplate_linux-amd64-slim -o /usr/local/bin/gomplate && chmod +x /usr/local/bin/gomplate
...
COPY config.yml.template /opt/jmx_exporter/
